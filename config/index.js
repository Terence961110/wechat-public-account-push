export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wxaeee51261d76dcce",

  // 公众号APP_SECRET
  APP_SECRET: "c23c2f756e8b1e0f2b9c02621cf64d20",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "jlW_PxEXGhmJR1qkzsq0GzDCvjZcSKxRI6nc0yhn-Bs",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "常州",
  ...
  CALLBACK_TEMPLATE_ID: "XI2AQH7n_Y6Lybu2ZN4kJ7EfRZWVZPZgAtLTEVRI1qE",
  ...
  FESTIVALS: [
    ...
    {"type": "节日", "name": "霜降", "year": "2022", "date": "10-23"},
    {"type": "节日", "name": "万圣节前夜", "year": "2022", "date": "10-31"},
  ],
  ...
  CUSTOMIZED_DATE_LIST: [
    ...
    // 结婚纪念日
    {"keyword": "marry_day", date: "2022-08-21"},
    // 退伍日, 不用可以删掉
